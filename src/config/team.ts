...
export const ENV_VARS_PROJECT_KEYS_URL = "/envvars/project/keys";
...
export const ENV_VARS_UNITTEST_PAGE_URL = "/envvars/unittest/page";
...
export const REQUEST_VERSION_ITERATION_ADD_URL = "/requests/iteration/add";

export const REQUEST_VERSION_ITERATION_DEL_URL = "/requests/iteration/del";
...
export const UNITTES_ITERATION_TEMPLATE_ADD_URL = "/unittest/iteration/addTemplate"